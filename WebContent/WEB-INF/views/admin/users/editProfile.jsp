...
<div class="row">
	<form
		action="${pageContext.request.contextPath }/admin/user/edit-profile"
		method="POST">
						...
						<div class="col-sm-6">
							<div class="form-group">
								<label for="name">Tên đăng nhập</label> <input type="text"
									...
									placeholder="${objUser.username }" value="${objUser.username }">
							</div>
							<div class="form-group">
								<label for="name">Họ tên</label> <input type="text"
									name="fullname" class="form-control"
									placeholder="${objUser.fullname }" value="${objUser.fullname }">
							</div>
